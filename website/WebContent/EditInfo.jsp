...
%>
 ...
 <!-- Product And Services Sec -->
	...
	<div id="fh5co-press" data-section="Services" style="margin-top:20px; padding-bottom:300px;  ">
		<div class="container">
			<div class="row">   
				<div class="col-md-12 section-heading text-center">
					<h2 class="single-animate animate-press-1">Edit profile</h2> <br/>
	            <br/>
					<div class="row">
       ...
       <div class="form-area">  
        ...
        <input type="Hidden"  name="type"  value="<%=resultSet.getString("UserType")%>">
