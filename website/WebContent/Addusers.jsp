 ...
 <!-- Product And Services Sec -->
	...
	<div id="fh5co-press" data-section="Services" style="margin-top:0px; padding-bottom:380px; ">
       ...
       <div class="form-area">  
        ...
        <form role="form" action="Addusers" method="post">
...
<option  value="spcust">Special Customer</option>
 ...
 <select  class="form-control" id="grp" name="task_select" style="visibility:hidden; margin-top:10px;">
<option class="dropdown-header"  autofuces >Choose type of Coordinator:</option>
<option value="task">Services</option>
...
<option value="contact">Contact</option>
 ...
 <!--  <label id="lab" style="visibility:hidden; float: left; margin-top:15px;"><b>Coordinator</b></label>
<div class=""></div>
...
<option value="contact">Contact</option>
   ...
   <center><button style=" margin-top:13px" type="submit" class="btn btn-primary btn-sm">Submit</button></center>
