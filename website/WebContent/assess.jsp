...
con = DriverManager.getConnection(url,user,psw);
 String id =""+session.getAttribute("id");
    ...
    try
{
String sql = "SELECT assess_status FROM marketing.assessments WHERE emp_id_s="+id;;
ps = con.prepareStatement(sql);
ResultSet rs = ps.executeQuery();
int count=0;
while(rs.next()){
String assess_status= rs.getString("assess_status");


if (! assess_status.equals("0") ){
%> 
<span id="notification_count">1</span>
 <a href="notifyassess.jsp" class="dropbtn"><i class="fa fa-th"></i> NOTIFICATION</a>
...
<div class="w3-container w3-padding-128" id="about">
  ...
  <img src="Assessing.jpg" style="width:1500px; height:400px;"/> 
  ...
  <br/>
      ...
      <center>
  <form  action="as1" method="post">
  
    Knowledge:<br>
    <input type="text" name="kw" value="" placeholder="ENTER YOUR KNOWLEDGE..." width="30" cols="100"><br>
    Experience:<br>
    <input type="text" name="exp" value="" placeholder="ENTER YOUR EXPERIENCE..." width="30" cols="100"><br>
    Soft Skills:<br>
     <input type="text" name="ss" value="" placeholder="ENTER YOUR SOFT SKILL..." width="30" cols="100"><br><br>
