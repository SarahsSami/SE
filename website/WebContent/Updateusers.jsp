...
String sql = "SELECT * FROM marketing.users where ID ="+request.getParameter("user");
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 section-heading text-center">
					<h2 class="single-animate animate-press-1">Update user Information</h2>
					<div class="row">
       ...
       <div class="form-area">  
        ...
        <br style="clear:both">
    				<div class="form-group">
						...
						<input type="text" class="form-control" id="name" name="name" placeholder="Name" required value="<%=resultSet.getString("Name")%>">
					</div>
                                        <div class="form-group">
                                                <label style="float: left;"><b>Password</b></label>
						<input type="password" class="form-control" id="subject" name="pass" placeholder="password" required value="<%=resultSet.getString("Password")%>">
					</div>
					<div class="form-group" >
                                            <label style="float: left;"><b>Email</b></label>
						<input type="email" class="form-control" id="email" name="email" placeholder="Email" required value="<%=resultSet.getString("email")%>">
					</div>
     <input type="Hidden"  name="id"  value="<%=request.getParameter("user")%>">
            
     <label style="float: left;"><b>User Type</b></label> <br>
    <select class="form-control" id="type" name="user_select" onChange="selectChange(this.value)">
...
<option value="service" class="dropdown-header">Services</option>
