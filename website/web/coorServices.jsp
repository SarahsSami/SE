<%-- 
    Document   : coorServices
    Created on : Aug 8, 2017, 1:58:56 PM
    Author     : waveform3
--%>
...
<br/>
      ...
      <a href="contact.html" class="dropbtn"><i class="fa fa-envelope"></i> CONTACT US</a>
         <a href="updateInfo.jsp" class="dropbtn"><i class="fa fa-edit"></i> CHANGE PASSWORD</a>
...
%> 
<span id="notification_count"><%= assess_status %></span>

<div class="dropdown">
 <a onclick="myFunction()" class="dropbtn"><i class="fa fa-th"></i> NOTIFICATION</a>
 <div id="myDropdown" class="dropdown-content">
    <a href="#"> CRM </a>
    <a href="newjsp.jsp" style= "background:#B22222"> Ideas Bank </a>
