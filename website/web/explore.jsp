<%-- 
    Document   : explore
    Created on : Jul 26, 2017, 10:12:13 AM
    Author     : Latefa
--%>
...
if (! explore_status.equals("0") ){
%> 
<span id="notification_count">1</span>
 <a href="notifyexplore.jsp" class="dropbtn"><i class="fa fa-th"></i> NOTIFICATION</a>
...
<div class="w3-container w3-padding-128" id="about">
    <center> <h1 class="w3-center" style="font-family: Castellar;">EXPLORE</h1> </center>
 
  <img src="exp.jpg" style="width:1500px; height:400px;"/> 
  ...
  <br/>
      ...
      <center>
  <form  action="addexplore" method="post">
  
    Knowledge:<br>
    <input type="text" name="kwx" value="" placeholder="ENTER YOUR KNOWLEDGE..." width="30" cols="150"><br>
    Experience:<br>
    <input type="text" name="expx" value="" placeholder="ENTER YOUR EXPERIENCE..." width="30" cols="150"><br>
    Soft Skills:<br>
     <input type="text" name="ssx" value="" placeholder="ENTER YOUR SOFT SKILL..." width="30" cols="150"><br><br>
