...
int y = Integer.parseInt(dp_status);
%>
<option value="<%=dp_status %>"><%=dp_status %></option>
</select>
...
<p> YOUR DEVELOPMENT PLAN ACCEPTED!</p>
...
case 2:
 ...
 %>
 <center> <p> YOUR DEVELOPMENT PLAN WAS DENIED</p>
 <p> FEEDBACK ABOUT YOUR DEVELOPMENT PLAN HAS BEEN SENT BY EMAIL</p> 
 <br>
...
%>
<center><p> YOUR DEVELOPMENT PLAN IS STILL ON WAITING LIST!</p>
