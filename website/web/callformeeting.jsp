<%-- 
    ...
    Input      : the cdpo will enter information to send call for meeting to the employee by email (sending the email will be done in sendMail1.java servlet. ).
    ...
    %>
        ...
        <table border="0">
            <tbody>
                ...
                <tr>
                    <td>Subject :</td>
                    <td><input type="text" name="subject" value="CDPO: Call for Meeting" size="50" /></td>
                </tr>
                
                <tr>
 
                    <td><textarea name="message" rows="4" cols="50"  > Day of Meeting: 
Time of Meeting:  </textarea></td>
