...
<div class="w3-container w3-padding-128" id="about">
    <center> <h1 class="w3-center" style="font-family: Castellar;">Deny </h1> </center>
...
<form  method="POST"  action="call.jsp" >
<input type="hidden" name="email" value="<%=email%>">
<input type="submit" value="Call for meeting" ></form>
...
<td align="center" valign="center">  
<center> 
     <form  method="POST"  action="feedback_TL.jsp" >
<input type="hidden" name="email" value="<%=email%>">
