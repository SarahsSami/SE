...
<div class="w3-container w3-padding-128" id="about">
    <center> <h1 class="w3-center" style="font-family: Castellar;"> VISION </h1> </center>
  ...
  <br/>
       ...
       <%
           ...
           String vision =request.getParameter("v");
           String email =request.getParameter("e");
    
    %>
    <center>
        <p >Employee Name : <%=name%> <br> Employee ID : <%=id%> </p> <br>
...
<form  method="POST"  action="delete" action = "deny.jsp">
<input type="hidden" name="id" value="<%=id%>">
